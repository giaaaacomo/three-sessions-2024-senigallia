...
export function sketch() {
    ...
    for (let i = 0; i < views.length; ++i) {
        const camera = new THREE.PerspectiveCamera(views[i].fov, window.innerWidth / window.innerHeight, 1, 10000);
        camera.position.fromArray(views[i].eye);
